                            ...
                            <div class="product__showing-result">
                                ...
                                <div class="product__menu-showing-sort">
                                    <div class="product__menu">
                                        <a href="projects.html" class="product__menu-icon-one"><span
                                                class="icon-menu"></span></a>
                                        <a href="projects-list.html" class="product__menu-icon-two"><span
                                    ...
                                    <div class="product__all-single-inner">
                                        ...
                                        <div class="product__all-content">
                                            <h4 class="product__all-title"><a
                                                    ...
                                                    $data->name }}</a></h4>
                                            <p class="product__all-price">{{ $data->name }}</p>
