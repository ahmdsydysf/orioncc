...
<head>
  ...
  <link rel="stylesheet" href="assets/js/flip/jquery.flipster.min.css" />
...
<body class="custom-cursor">
      ...
      <div class="main-header__wrapper">
        <div class="main-header__wrapper-inner">
          <div class="main-header__logo">
            <a href="index.html"><img src="assets/images/resources/logo-white.webp" alt="Orion Company White Logo"></a>
          </div>
                    ...
                    <div class="main-menu__right">
                      <div class="main-menu__search-cart-btn">
                        ...
                        <div class="main-menu__btn-box">
                          <a href="" class="thm-btn main-menu__btn">Contact Us</a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <ul class="contact-details__contact-list list-unstyled d-flex flex-wrap">
                  ...
                  <li class="col-12 col-md-12 d-flex justify-content-center mt-3">
                    ...
                    <div class="content text-center">
                      <p>Visit Us</p>
                      <h4>Al Hamrah Industrial Zone Al Jazirah Alhamra – Ras al Khaimah – United Arab Emirates</h4>
                    </div>
                  </li>
                </ul>
  ...
  <div class="mobile-nav__wrapper">
    ...
    <div class="mobile-nav__content">
      ...
      <div class="logo-box">
        <a href="index-2.html" aria-label="logo image"><img src="assets/images/resources/logo-white.webp" width="104"
            alt="" /></a>
      </div>
      <!-- /.logo-box -->
